...
Command: npx gltfjsx@6.5.0 .\public\models\Idle.glb -t 
*/
...
type ActionName = 'Action' | 'Armature.001|mixamo.com|Layer0.001' | 'Armature.001|mixamo.com|Layer0.002' | 'Target.001|Target|Action' | 'Target.001|Target|Action.001' | 'Target.001|Target|Armature|Take 001|BaseLayer' | 'Target.001|Target|Armature|Take 001|BaseLayer.001' | 'Target.001|Target|Armature|Take 001|BaseLayer.001 Retarget' | 'Target.001|Target|Armature|Take 001|BaseLayer.001 Retarget.001' | 'Target.001|Target|Armature|Take 001|BaseLayer.001 Retarget_' | 'Target.001|Target|Armature|Take 001|BaseLayer.001 Retarget_.001' | 'Target.001|Target|Armature|Take 001|BaseLayer.001 Retarget_Targ' | 'Target.001|Target|Armature|Take 001|BaseLayer.001_Target.001' | 'Target.001|Target|Armature|Take 001|BaseLayer.001_Target.001_Ta' | 'Target.001|Target|Armature|Take 001|BaseLayer.001_Target.002'
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature001">
          ...
          <skinnedMesh name="Body001" geometry={nodes.Body001.geometry} material={materials['rp_nathan_animated_003_mat.001']} skeleton={nodes.Body001.skeleton} />
          <skinnedMesh name="Head001" geometry={nodes.Head001.geometry} material={materials.Head} skeleton={nodes.Head001.skeleton} />
        </group>
        <group name="cs_grp">
