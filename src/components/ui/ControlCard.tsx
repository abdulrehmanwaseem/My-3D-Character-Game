...
const ControlCard = ({ text = "", keyboardKey = "" }) => {
  return (
    <div className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-800 rounded-lg w-fit bg-slate-800/80 backdrop-blur-sm dark:text-gray-100">
