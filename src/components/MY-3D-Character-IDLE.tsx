...
Command: npx gltfjsx@6.5.0 .\MY 3D Character IDLE.glb -ts 
*/
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  ...
  const { scene, animations } = useGLTF("/models/MY 3D Character IDLE.glb");
...
useGLTF.preload("/models/MY 3D Character IDLE.glb");
