  ...
  return (
    <group ref={group} {...props} dispose={null} receiveShadow castShadow>
      <group name="Scene" receiveShadow castShadow>
        ...
        >
          <group
            name="rp_nathan_animated_003_walking_CTRL"
            receiveShadow
            castShadow
          >
            <group name="Armature">
          ...
          <group
            name="rp_nathan_animated_003_walking_geoGRP"
            receiveShadow
            castShadow
          />
        </group>
        ...
        >
          <group
            name="rp_nathan_animated_003_walking_CTRL001"
            receiveShadow
            castShadow
          />
          <group
            name="rp_nathan_animated_003_walking_geoGRP001"
            receiveShadow
            castShadow
          />
        </group>
