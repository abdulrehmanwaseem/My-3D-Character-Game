...
Command: npx gltfjsx@6.5.0 .\public\models\My_3d_Character.glb -ts 
*/
...
type ActionName = 'Armature|Take 001|BaseLayer' | 'rp_nathan_animated_003_walking|Take 001|BaseLayer'
...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="rp_nathan_animated_003_walking001" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
